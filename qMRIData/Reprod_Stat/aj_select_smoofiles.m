% function selected_files = aj_select_smoofiles(tmp_unzip_dir, smoo, smoo_dir, smoo_approaches, qmetric, TC)

function selected_files = aj_select_smoofiles(smoo, smoo_dir, smoo_approaches, qmetric, TC)
