...
load('E:\Master_Thesis\Data\BIDS_AgingData\reg_age_centered.mat');
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(1).c = age_c;
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(1).cname = 'Centered Age';
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(1).iCC = 1;
load('E:\Master_Thesis\Data\BIDS_AgingData\reg_age_centered_squared.mat');
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(2).c = age_c2;
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(2).cname = 'Centered Squared Age';
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(2).iCC = 1;
load('E:\Master_Thesis\Data\BIDS_AgingData\reg_sex.mat');
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(3).c = sex;
...
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(4).c = TIV;
...
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(5).c = scanner;
matlabbatch{1}.spm.stats.factorial_design.des.mreg.mcov(5).cname = 'Scanner';
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Increase with age and with the quadratic age term';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [0 1 1 0 0 0]; % intercept in the first column
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Decrease with age and with the quadratic age term';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = [0 -1 -1 0 0 0];
matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{3}.fcon.name = 'Any effect of age and age^2';
